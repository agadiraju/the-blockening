...
const SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'ben-post-guide',    text: '(USA) Download the Post-Block Benefits Guide from Workday → Profile → Overview for details on what happens after termination' },
      { id: 'ben-cobra-packet',  text: '(USA) Watch for a COBRA packet from Optum in the mail — arrives 10–14 business days after your benefits coverage ends' },
      { id: 'ben-cobra-enroll',  text: '(USA) Enroll in COBRA through Optum — you have 60 days from the packet or your separation date, whichever is later' },
      { id: 'ben-cobra-note',    text: '(USA) Signing your agreement unlocks 3 months of Block-covered COBRA premiums after your separation date — you must still enroll through Optum to receive this.<br><br><strong>PSA: if your spouse has their own employer plan, think carefully before choosing COBRA. Losing your coverage is a Qualifying Life Event (QLE) that lets you join their plan — but if you elect COBRA instead, you may forfeit that option until COBRA runs out (up to 18 months). If a spouse\'s plan is available to you, it may be the better choice.</strong>' },
      { id: 'ben-401k',          text: '(USA) Adjust 401K contribution elections if needed via your Fidelity NetBenefits account (changes take 1–2 pay periods).<br><br><strong>Block\'s match: 100% of first $2K + 50% of next $6K = up to $5K employer match after $8K in employee contributions.</strong>' },
      ...
      { id: 'ben-unemployment',  text: '(USA) File for unemployment insurance promptly — deadlines vary by state, typically within 1–2 weeks of your separation date' },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'pay-aus',           text: '(AUS/NZ/France) Navigate to PwC GPP (go/pwc, requires Okta sign-in) and export all pay stubs.' },
      { id: 'pay-international', text: '(International) Access pay stubs via your country-specific portal listed in your offboarding materials (Germany: DATEV; UK: my@PayWindow; etc.)' },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'it-wipe-note',    text: 'Block sent a remote wipe signal on Feb 26 at 7pm PT (NA), or will send on the last day of your consultation period. If your device isn\'t online, it will wipe the next time it connects' },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'car-auto-summary', text: '(Consultation period only) Use go/aichat, go/g2, or go/personal-summaries to build a summary of your contributions' },
  ...
  },
  {
    ...
    color: 'ic-amber',
    items: [
      { id: 'doc-workday-all',     text: 'Export your Workday profile. → Profile → "PDF" icon above your name on the right-hand sidebar. before your access ends' },
      ...
      { id: 'doc-401k-rollover',   text: '(USA) When you start your next role, consider rolling your Block 401K into your new employer\'s plan or a personal IRA' },
    ],
  },
];
