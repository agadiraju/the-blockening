...
const SECTIONS = [
  {
    ...
    color: 'ic-amber',
    items: [
      { id: 'urg-workday-email',   text: 'Check your personal email — Workday login credentials (username + temp password) arrive within 24 hours' },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'agr-dates',            text: 'Record your key dates: Notification Date, Separation Date, and Extended Separation Date (if applicable for LOA or NY state)' },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'ben-cobra-note',    text: 'If you signed your agreement, Block pays Optum directly for 3 months — but enrollment is still required on your end' },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'eq-espp-check',      text: 'Check your ESPP participation at etrade.com — you may continue through your separation date, and if that date is on or after May 15, 2026, your contributions will be used for the May 15 purchase' },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'it-mdm-personal', text: 'Block MDM will auto-prompt removal from your personal phone/iPad each Friday — follow the prompts when it appears' },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'car-unemployment', text: 'File for unemployment insurance promptly — deadlines vary by state, typically within 1–2 weeks of separation' },
