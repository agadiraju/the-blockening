...
const SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'ben-401k',          text: 'Adjust 401K contribution elections if needed via your Fidelity NetBenefits account (changes take 1–2 pay periods).<br><br><strong>Block\'s match: 100% of first $2K + 50% of next $6K = up to $5K employer match after $8K in employee contributions.</strong>' },
